...
plot_tm_genome_tracks(tm_results)
...
# Example usage by plot_tm_heatmap with default settings
plot_tm_heatmap(tm_results)

# Example usage by plot_tm_heatmap with custom settings
plot_tm_heatmap(tm_results, plot_type = "faceted", color_palette = "viridis")
```
