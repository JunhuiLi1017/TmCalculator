...
tm <- tm_calculate(hg38, BPPARAM = SnowParam(workers = 5))$gr
```
...
```{r sources}
tm_calculate(hg38)                       # an installed BSgenome package
tm_calculate("contigs.fa.gz")            # a FASTA file, gzip is fine
...
tm_calculate(hg38, regions = 1:22)                                # autosomes
...
tm_calculate(hg38, regions = c(1:20, "chr21:1-10e6", "X", "Y"))
