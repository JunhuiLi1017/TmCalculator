...
#
#   Rscript inst/scripts/make_figure4.R
#   Rscript inst/scripts/make_figure4.R --csv bench200/bench_crosstool.csv
#   Rscript inst/scripts/make_figure4.R --memory        # add a third panel
#
...
## -- Write -----------------------------------------------------------------
stem <- file.path(outdir, "figure4_tool_comparison")
