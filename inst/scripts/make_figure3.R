...
#
#   Rscript inst/scripts/make_figure3.R                 # PDF + 600 dpi TIFF
#   Rscript inst/scripts/make_figure3.R --dpi 300       # smaller raster
#   Rscript inst/scripts/make_figure3.R --gap 0.05 --axis-cex 0.45
#
...
## -- Write -----------------------------------------------------------------
stem <- file.path(outdir, "figure3_window_size")
